...
<head>
   ...
   <link rel="stylesheet" href="../css/watch-video.css">
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="../view/home.php" class="logo">Learning Sphere</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../view/tutors.php"><i class="fas fa-chalkboard-user"></i><span>Tutors</span></a>
...
<section class="watch-video">
   ...
   <div class="video-container">
      ...
      <form action="" method="post" class="flex">
         <a href="../view/playlist.php" class="inline-btn">view playlist</a>
